            ...
            <div className="grid grid-cols-auto gap-6 my-10">
                {serviceData.map(
                    ({ description, icon, title, link }, index) => (
                        <div key={title} className='border border-gray-400 rounded-lg px-8 py-12 hover:-translate-y-1 duration-500 hover:shadow-black cursor-pointer hover:bg-lightHover'>
